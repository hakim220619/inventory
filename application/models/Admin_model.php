...
class Admin_model extends CI_Model
{
  ...
  <div id="didie"></div>
    ...
    public function am_search_history()
    {
        ...
        <a href="' . base_url('cetak/history_penjualan_ex/' . $dari . '/' . $ke . '/' . $penempatan) . '" target="_blank" class="btn btn-outline-primary btn-sm mb-4" title="Cetak"><i class="fas fa-print"></i> Cetak</a>
    ...
    public function am_search_data_jual_hari()
    {
        ...
        <a href="' . base_url('cetak/laporan_penjualan_hari_ex/' . $dari . '/' . $ke . '/' . $penempatan) . '" target="_blank" class="btn btn-outline-primary btn-sm mb-4" title="Cetak"><i class="fas fa-print"></i> Cetak</a>
    ...
    public function am_search_history_pengeluaran()
    {
        ...
        <a href="' . base_url('cetak/laporan_pengeluaran_ex/' . $dari . '/' . $ke . '/' . $user['penempatan_cabang']) . '" target="_blank" class="btn btn-outline-primary btn-sm mb-4" title="Cetak"><i class="fas fa-print"></i> Cetak</a>
    ...
    public function am_search_data_pengeluaran_hari()
    {
        ...
        <a href="' . base_url('cetak/laporan_pengeluaran_hari_ex/' . $dari . '/' . $ke . '/' . $penempatan) . '" target="_blank" class="btn btn-outline-primary btn-sm mb-4" title="Cetak"><i class="fas fa-print"></i> Cetak</a>
    ...
    public function am_struk_penjualan_c($id_pembelian)
    {
        ...
        $output = '';
        $output .= '
        <div class="container-fluid text-pure-dark" style= "font-family:monoscpace; font-size: 20px; font-weight:; !important" >
        ...
        <div class="row">
            <div class="col-md-12 sizenya-paper" style="border: 1px solid #000;">
                <div class="row">
                    ...
                    <div class="col-md-12 mt-4 mb-1" style= "font-family:arial; font-size: 20px; font-weight:; " >
                    ...
                    <div class="col-md-12" style= "font-family:arial; font-size: 18px; font-weight:; ">
